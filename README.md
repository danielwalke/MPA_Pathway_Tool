...
### 1.1 Description
The MPA_Pathway_Tool is a user-friendly, stand-alone web application.It was implemented in Java and ReactJS. It will be freely available on http://mpa-pathwaymapper.ovgu.de/.
