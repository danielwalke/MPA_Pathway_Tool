    ...
    return (
        <div className={"captionContainer3"}>
            <div className={"num"} style={{display: "grid", gridTemplateColumns: " repeat(5, 20%)", width: "94vw"}}>
                <div style={{justifySelf: "start"}}><input data-tip={"lower limit"} style={{width: "4vw"}}
                                                           type={"number"}
                                                           onChange={(e) => dispatch({
                ...
                <div style={{justifySelf: "end"}}><input data-tip={"second upper limit of the colored heatmap"}
                                                         style={{width: "4vw"}} type={"number"}
                                                         onChange={(e) => dispatch({
