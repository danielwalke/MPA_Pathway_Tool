...
const TaxonomyNcbi = (props) => {
    ...
    const handleChange = (e) => {
        ...
        requestGenerator("POST", endpoint_getFilteredTaxonomicNames, {
            rank: state.general.taxonomicRank,
            subName: e.target.value.toLowerCase()
        }, "", "").then( //endpoint: sends max. 100 taxonomic names
            resp => {
