    ...
    return (
        <div>
            <div style={{display: "flex"}}><Checkbox checked={isChanged}/><TextField
                variant={"outlined"}
                size={"small"} defaultValue={props.reaction.sbmlName} value={reactionSbmlNames[props.index]}
                onChange={(e) => {
            ...
            <button style={{width: 0.1 * window.innerWidth}} onClick={() => handleSubmitChange()}
