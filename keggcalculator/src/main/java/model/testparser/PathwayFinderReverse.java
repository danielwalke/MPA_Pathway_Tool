...
public class PathwayFinderReverse {
	...
	public PathwayFinderReverse(KeggDataObject keggData, String substrateId, String productId) {
	...
	public int findPathways() {
		...
		for (KeggReactionObject r : this.inputSubstrat.getProductReactions()) { 
